...
would expand control over the Spiegel program signi.cantly. The expansion of
...
close approximation to the orientation speci.ed by the user in software in
...
placed above the .rst two. Additionally, the error in sensing the points could
be reduced by the addition of a another Wii Remote placed above the .rst two.
