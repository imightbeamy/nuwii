...
context of head tracking \cite{Cuypers09}. Head tracking limits the
points range of motion making it easier to correctly distinguish the points.
Other projects had minimal error checking involved \cite{Hay08}. In contrast, NuWii is able to track two points under more general
conditions.
...
\begin{figure}[hb] \begin{center} \includegraphics[width = 7.5cm]{Camera}
