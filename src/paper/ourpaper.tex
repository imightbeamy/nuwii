...
%Foundation under Award No. CCF-0851743.\\
%    Astrophysical data was provided by RIT's Center for Computational 
%Relativity and Gravitation (CCRG).

\renewcommand{\baselinestretch}{0.98}
\bibliographystyle{apalike}
{\small
\bibliography{ourpaper}}
